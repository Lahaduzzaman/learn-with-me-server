...
client.connect(err => {
    const serviceCollection = client.db("learnWithMe").collection("services");
    const orderCollection = client.db("learnWithMe").collection("order");
    const reviewCollection = client.db("learnWithMe").collection("review");
    const adminCollection = client.db("learnWithMe").collection("admin");
